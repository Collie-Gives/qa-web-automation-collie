...
public class ConstantManager {
    ...
    public static String NUMBER_CARD = "42424242424242";
    public static String DATE_CARD = "05/27";
    public static String CVS_CARD = "123";
    public static final long TIME_OUT_5 = 5;
    public static final long TIME_OUT_10 = 10;
    public static final long TIME_OUT_15 = 15;
    public static final long TIME_OUT_20 = 20;
