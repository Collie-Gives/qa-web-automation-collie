Feature: Create campaign in colliegives.com application
  ...
  Scenario Outline: Create a successful campaign by adding an experience
    ...
    * And add to the experience general settings
    ...
    Examples:
      | user      | city  | state   | star_date  | end_date   | fundraising | attendees | teams | experienceName | experienceCategory |
      | USER_ERIK | Miami | Florida | 09/10/2024 | 09/20/2024 | 100         | 20        | 5     | Race for life  | Run/Walk           |